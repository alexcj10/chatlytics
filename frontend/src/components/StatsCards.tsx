    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {cards.map((card, i) => (
                <div
                    key={i}
                    className={`relative group overflow-hidden rounded-xl md:rounded-[1.5rem] border ${card.borderColor} ${card.bgColor} p-4 md:p-6 transition-all duration-300 hover:scale-[1.02] hover:bg-zinc-900/80 [-webkit-tap-highlight-color:transparent] touch-manipulation`}
                >
