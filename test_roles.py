...
def test_roles_top3():
    ...
    data = {
        'date': pd.to_datetime([
            ...
            '2023-01-03 14:00:00', '2023-01-03 14:05:00',
    ...
    for role in expected_roles:
        ...
        assert "user" in roles[role]["top"][0], f"Missing user field in top list for {role}"
    
    print("\nSUCCESS: Top 3 participants identified per role as requested.")
